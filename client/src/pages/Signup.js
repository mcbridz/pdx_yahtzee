                     ...
                     <div class="col col-lg-3 mt-2">
                       <div class="text-center">
                         ...
                         <div class="form-group mt-4">
                             <input value={firstnameText} onChange={handleFirstnameChange} class="form-control" placeholder="Enter First Name" type="text" />
                           </div>
                          <div class="form-group mt-4">
                             <input  value={lastnameText} onChange={handleLastnameChange} class="form-control" placeholder="Enter Last Name" type="text"/>
                           </div>
                            <div class="form-group mt-4">
                             <input  value={emailText} onChange={handleEmailChange} class="form-control" placeholder="Enter Email" type="email"/>
                           </div>
