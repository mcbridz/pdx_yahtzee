...
scoreCardSchema.methods.markSmStraight = async function (data, taskObj, room) {
  if (!this.lowerSection[3].marked) {
    if (data === true) {
      this.lowerSection[3].smStraight = this.lowerSection[3].value;
    } else {
      this.lowerSection[3].smStraight = 0;
    }
...
scoreCardSchema.methods.packCard = function () {
  let output = {
    ...
    upperSection: [
      ...
      {
        threes: this.upperSection[2].threes,
        marked: this.upperSection[2].marked,
      },
      {
        fours: this.upperSection[3].fours,
        marked: this.upperSection[3].marked,
      },
      {
        fives: this.upperSection[4].fives,
        marked: this.upperSection[4].marked,
      },
      {
        sixes: this.upperSection[5].sixes,
        marked: this.upperSection[5].marked,
      },
    ],
    bonus: this.bonus,
    ...
    lowerSection: [
      {
        threeOfAKind: this.lowerSection[0].threeOfAKind,
        marked: this.lowerSection[0].marked,
      },
      {
        fourOfAKind: this.lowerSection[1].fourOfAKind,
        marked: this.lowerSection[1].marked,
      },
      {
        fullHouse: this.lowerSection[2].fullHouse,
        marked: this.lowerSection[2].marked,
      },
      {
        smStraight: this.lowerSection[3].smStraight,
        marked: this.lowerSection[3].marked,
      },
      {
        lgStraight: this.lowerSection[4].lgStraight,
        marked: this.lowerSection[4].marked,
      },
      {
    ...
    yahtzeeBonus: {
      ...
      numYahtzees: this.yahtzeeBonus.numYahtzees,
    },
